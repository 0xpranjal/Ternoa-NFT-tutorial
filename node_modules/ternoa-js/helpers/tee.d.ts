 ...
 */
export declare const getEnclaveHealthStatus: (clusterId?: number) => Promise<EnclaveHealthType[]>;
/**
 ...
 */
export declare const getEnclaveDataAndHealth: (clusterId?: number) => Promise<EnclaveDataAndHealthType[]>;
/**
 ...
 */
export declare const getFirstPublicClusterAvailable: () => Promise<number | undefined>;
/**
