 ...
 * @returns Number.
 */
var getAuctionEndingPeriod = function () {
    var endingPeriod = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.auctionEndingPeriod);
 ...
 * @returns Number.
 */
var getAuctionGracePeriod = function () {
    var gracePeriod = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.auctionGracePeriod);
 ...
 * @returns Number.
 */
var getBidderListLengthLimit = function () {
    var limit = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.bidderListLengthLimit);
 ...
 * @returns Number.
 */
var getMaxAuctionDelay = function () {
    var maxDelay = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.maxAuctionDelay);
 ...
 * @returns Number.
 */
var getMinAuctionDuration = function () {
    var minDuration = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.minAuctionDuration);
 ...
 * @returns Number.
 */
var getMaxAuctionDuration = function () {
    var maxDuration = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.maxAuctionDuration);
 ...
 * @returns Number.
 */
var getParallelAuctionLimit = function () {
    var limit = (0, blockchain_1.consts)(constants_1.txPallets.auction, constants_1.chainConstants.parallelAuctionLimit);
    return Number.parseInt(limit.toString());
};
