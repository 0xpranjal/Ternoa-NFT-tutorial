 ...
 */
var getAccountAssetData = function (assetId, address) { return __awaiter(void 0, void 0, void 0, function () {
    var accountData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, blockchain_1.query)(constants_1.txPallets.assets, constants_1.chainQuery.account, [assetId, address])];
            case 1:
                accountData = (_a.sent()).toJSON();
 ...
 */
var getAccountAssetBalance = function (assetId, address) { return __awaiter(void 0, void 0, void 0, function () {
    var data, balance;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getAccountAssetData)(assetId, address)];
            case 1:
                data = _a.sent();
                balance = data ? (0, util_1.bnToBn)(data.balance) : null;
