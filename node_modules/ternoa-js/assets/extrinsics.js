 ...
 */
var assetTransferTx = function (id, to, amount) { return __awaiter(void 0, void 0, void 0, function () {
    var formattedAmount;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                formattedAmount = typeof amount === "number" ? (0, blockchain_1.numberToBalance)(amount) : amount;
                return [4 /*yield*/, (0, blockchain_1.createTxHex)(constants_1.txPallets.assets, constants_1.txActions.transfer, [id, to, formattedAmount])];
 ...
 */
var assetTransfer = function (id, to, amount, keyring, waitUntil) { return __awaiter(void 0, void 0, void 0, function () {
    var tx, events;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.assetTransferTx)(id, to, amount)];
            case 1:
                tx = _a.sent();
                return [4 /*yield*/, (0, blockchain_1.submitTxBlocking)(tx, waitUntil, keyring)];
            case 2:
                events = (_a.sent()).events;
                return [2 /*return*/, events.findEventOrThrow(events_1.AssetTransferredEvent)];
        }
    });
}); };
