 ...
 */
var getKeyringFromSeed = function (seed, hardPath, softPath, passwordPath) { return __awaiter(void 0, void 0, void 0, function () {
    var _suri, keyring;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                _suri = seed +
                    "".concat(hardPath ? "//".concat(hardPath) : "") +
                    "".concat(softPath ? "/".concat(softPath) : "") +
                    "".concat(passwordPath ? "///".concat(passwordPath) : "");
                keyring = new keyring_1.Keyring();
                return [2 /*return*/, keyring.createFromUri(_suri, {}, "sr25519")];
        }
    });
}); };
